...
menu_list = [
    # ===== メイン料理 =====
    "カレー", "親子丼", "焼きそば", "パスタ", "麻婆豆腐", "オムライス",
    "ハンバーグ", "生姜焼き", "チャーハン", "豚丼", "うどん", "そば",
    "鍋", "そうめん", "冷やし中華", "おでん", "シチュー",

    # ===== 簡単系 =====
    "簡単ご飯系（卵かけ・納豆）", "お茶漬け", "おかゆ（雑炊）",
